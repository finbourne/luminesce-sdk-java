...
* token expiry to ensure continued connectivity to luminesce API without the need
...
public class RefreshingTokenProvider {
    ...
    * that manages direct authentication with luminesce.
    *
    * @param httpFinbourneTokenProvider underlying provider that manages explicit authentication calls to luminesce
    */
