...
public class SqlBackgroundExecutionApi {
    ...
    private okhttp3.Call getProgressOfCall(String executionId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private ApiResponse<BackgroundQueryProgressResponse> getProgressOfWithHttpInfo(String executionId) throws ApiException {
    ...
    private okhttp3.Call getProgressOfAsync(String executionId, final ApiCallback<BackgroundQueryProgressResponse> _callback) throws ApiException {
    ...
    public class APIgetProgressOfRequest {
        ...
        public ApiResponse<BackgroundQueryProgressResponse> executeWithHttpInfo() throws ApiException {
            return getProgressOfWithHttpInfo(executionId);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<BackgroundQueryProgressResponse> _callback) throws ApiException {
            return getProgressOfAsync(executionId, _callback);
        }
    }
    ...
    private okhttp3.Call startQueryCall(String body, String queryName, Integer timeoutSeconds, Integer keepForSeconds, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private ApiResponse<BackgroundQueryResponse> startQueryWithHttpInfo(String body, String queryName, Integer timeoutSeconds, Integer keepForSeconds) throws ApiException {
    ...
    private okhttp3.Call startQueryAsync(String body, String queryName, Integer timeoutSeconds, Integer keepForSeconds, final ApiCallback<BackgroundQueryResponse> _callback) throws ApiException {
    ...
    public class APIstartQueryRequest {
        ...
        public ApiResponse<BackgroundQueryResponse> executeWithHttpInfo() throws ApiException {
            return startQueryWithHttpInfo(body, queryName, timeoutSeconds, keepForSeconds);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<BackgroundQueryResponse> _callback) throws ApiException {
            return startQueryAsync(body, queryName, timeoutSeconds, keepForSeconds, _callback);
        }
    }
